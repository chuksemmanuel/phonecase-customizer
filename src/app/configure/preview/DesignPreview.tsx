							...
							<div className='flow-root text-sm'>
								...
								{finish && (
									<div className='flex items-center justify-between py-1 mt-2'>
										...
										<p className='font-medium text-gray-900'>{formatPrice(PRODUCT_PRICES.finish[finish] / 100)}</p>
									</div>
								)}
								{material && (
									<div className='flex items-center justify-between py-1 mt-2'>
										<p className='text-gray-600'>{material.charAt(0).toUpperCase() + material.slice(1)} material</p>
										<p className='font-medium text-gray-900'>{formatPrice(PRODUCT_PRICES.material[material] / 100)}</p>
									</div>
								)}
